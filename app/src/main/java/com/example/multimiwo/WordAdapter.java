...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public WordAdapter(Activity context, ArrayList<Word> words, Integer color) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // adding the additional code for showing the image Note we just need to add this line, here Nothing more change is required
